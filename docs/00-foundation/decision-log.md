...
| **D-007 (Q9, partial)** | 2026-07-26 | **Founder constraints recorded:** collaborators — solo founder currently; skills — third-year software engineering student, familiar with TypeScript, React, Next.js and AI-assisted development; can contribute to product and technical work, with specialist review expected for professional mobile UX, visual design, accessibility, security, programme expertise and store readiness; timing — no fixed release date, **quality gates take priority**; acquisition — not yet validated, testable organic channels to be prepared. *(Time and budget elements superseded same day by D-008 and D-010.)* | Founder answers, 26 Jul 2026 | Any change in collaborators/skills | **Founder** |
| **D-008 (FD-5)** | 2026-07-26 | **Founder capacity and operating model.** The earlier 15–20 h/week planning assumption is **withdrawn**. Plan for **3–5 founder hours in ordinary weeks**, up to **6–8 hours at major review/approval gates**, protecting founder time for university, business, travel and other responsibilities. Operating principle: *"Advanced agents perform the heavy preparation and execution. The founder reviews major evidence, decides important product questions and approves quality gates."* Research, documentation, analysis, preparation, engineering and testing are completed autonomously wherever safe; founder involvement focuses on vision, taste, commercial direction, significant spending and irreversible decisions. Operationalised in [`10-roadmap/delivery-operating-model.md`](../10-roadmap/delivery-operating-model.md). | Founder direction, 26 Jul 2026 | Founder instruction only | **Founder** |
| **D-009 (FD-6)** | 2026-07-26 | **Moderated interviews are an escalation tool, not the default.** Founder-led 9–12 interviews are no longer Stage 1's default method; the default is public-evidence synthesis plus passive real-world validation. The interview pack is retained and recommended **only when**: public evidence materially conflicts; passive behaviour cannot explain an important result; a safety-sensitive question remains unresolved; age-inclusive usability failures require diagnosis; willingness-to-pay evidence remains too ambiguous; or a major decision cannot responsibly be made from existing evidence. | Founder direction, 26 Jul 2026 | Escalation triggers firing | **Founder** |
| **D-010 (FD-7)** | 2026-07-26 | **Gated-capital model** replaces the Lean/Standard/Comfortable budgets as spending authority (those remain planning references only). Gate A foundation/evidence synthesis: £0–100. Gate B passive validation: ≤£300 cumulative without new approval. Gate C interactive prototype: £500–1,000 cumulative target. Gate D private beta: £1,000–1,500 cumulative target. Gate E public launch: provisional £3,000–6,000 route prepared, **new founder decision required before commitment**. Professional quality is deferred, not removed: specialist expenses unlock on evidence triggers per [`05-commercial/staged-capital-plan.md`](../05-commercial/staged-capital-plan.md). | Founder direction, 26 Jul 2026 | Gate passage; evidence triggers | **Founder** |
