...
| R-08 | Health-content harm or claim breach (weight-loss category, if chosen) | 2 | 5 | 10 | Safety | Content governance (Part 4E docs); 18+ gate (D-005); claims policy; qualified reviewer requirement; category choice Q1 | Q1 decision; reviewer audit | Content |
...
| R-15 | Subscription edge-case defects (restore, refund, expiry, offline entitlement) reach production | 3 | 4 | 12 | Engineering | Subscription lifecycle test suite (Part 4J); sandbox edge-case pass at Stage 8; billing integrity monitored at rollout | Stage 8 test report | Engineering |
