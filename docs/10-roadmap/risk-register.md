...
| R-06 | Founder capacity: 3–5 h/week (D-008) is exceeded by gate loads, or agent-led work queues on founder attention | 3 | 4 | 12 | Delivery | Delivery operating model (gate packs ≤2h reads, founder inbox, async gates); escalation batching; stop-not-guess rule | Gate weeks exceeding 8h; inbox ageing >2 weeks | Product lead |
...
| R-18 | Passive-system organic traffic stalls below read-thresholds, starving Stage 1B of evidence (the ≥100-qualified-vote floor prices at ≈2,500–4,200 visitors — passive-plan §4.2) | 4 | 3 | 12 | Research | Multi-channel organic plan sustained across the six-week window; Extend/Escalate at the read date is the designed response (never lowering floors); documented-effort rule before paid top-up (founder go, Gate B cap); null weeks reported honestly | Vote-accumulation trajectory "far-short" on the dashboard after 3 weeks of documented posts | Implementer |
| R-19 | Synthetic or public-evidence material gets treated as real user validation | 2 | 5 | 10 | Research | Labelling discipline (every synthetic artefact marked; classifications on every corpus row); reviewer checks; validation-evidence.md reserved for genuine behaviour only | Any unlabelled citation found | Independent reviewer |
| R-20 | 12-week-term billing may be unconfigurable in store subscription periods (month-shaped units), cracking the honesty framing of M3 | 3 | 4 | 12 | Commercial | Verify SKU configurability in App Store Connect/Play Console at Stage 2 (before any pricing copy hardens); fallback framings (3-month term honestly labelled; one-off programme purchase) already in the options set | SKU configuration attempt | Product lead |
| R-21 | Pause/recovery semantics collide with term billing (paying for weeks not received; term boundary landing mid-lapse) | 3 | 4 | 12 | Commercial/UX | Reconcile challenge-lifecycle ↔ entitlement states on paper at Stage 2 (design task registered); recovery-moment paywall ban already in principles; grace windows | Stage-2 paper audit | Product lead |
